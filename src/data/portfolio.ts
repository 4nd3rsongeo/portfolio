...
const getThumbnail = (url: string) => `https://s0.wp.com/mshots/v1/${encodeURIComponent(url)}?w=600`;
    ...
    projects: [
      {
        ...
        image: getThumbnail("https://petshop-self-three.vercel.app/")
      },
      {
        ...
        image: getThumbnail("https://react-proj-final.vercel.app/")
      },
      {
        ...
        image: getThumbnail("https://lojaescoteira21.vercel.app/")
      },
      {
        ...
        image: getThumbnail("https://onebitflix-frontend-roan.vercel.app/")
      },
      {
        type: "Landing Page",
        name: "Inovart",
        ...
        image: getThumbnail("https://inovart-flax.vercel.app/")
      },
      {
        type: "Curriculum",
        name: "Curriculum",
        ...
        image: getThumbnail("https://curriculum-pearl-mu.vercel.app/")
      }
    ]
  },
  en: {
